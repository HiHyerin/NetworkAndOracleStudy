...
/*
 		클래스 종류
 		=========
 	*	추상클래스 : 미완성된 클래스 => 메모리에 할당 불가능 => 사용자가 상속을 받아서 처리
 		-------- = java.io
 	...
 	*	인터페이스 : 추상클래스의 일종 , 미완성된 클래스 => 클래스 여러개 묶어서 한개의 이름으로 사용
 		...
 		public interface InterfaceName{
 			...
 			-구현된 메소드
 			 (public) static default void aaa(){}
 			 
 		}
 		
 		
 	*	내부클래스
 		= 멤버클래스 (클래스의 내용(변수, 메소드) 공유) => static을 이용 => 쓰레드 , 윈도우 , 서버구축
 			class A{
 				-공유할 데이터
 				-공유할 메소드
 				 class B{
 				 	A가 가지고 있는 모든 메소드, 변수 사용 가능(private 사용 가능)
 				 }
 			}
 		= 익명의 클래스 : 상속을 하지 않는 경우가 많다.
 					   ------------------------ex) 스프링, 마이바티스 => 오버라이딩은 익명의 클래스 이용
 	...
 	*	종단클래스 => 사용자 정의는 거의 없다 => java.lang.*
 			public final class ClassName{
 			
 			}
 			=> 상속을 내릴 수 없다 => String, System, Math, StringBuffer, Wrapper...
 */
